...
export const CommandDashboard: React.FC<CommandDashboardProps> = ({ onModuleChange }) => {
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: liveMetrics.stockAlerts,
      trend: "Warning",
      prediction: "Lagos out of Shampoo in 2 days",
      icon: Package,
      color: "yellow",
      alert: true,
    ...
    },
    {
      ...
      value: `₦${liveMetrics.revenue.toFixed(1)}M`,
      trend: "+23%",
      prediction: "₦2.8M projected",
      icon: DollarSign,
      color: "green",
      alert: false,
    ...
    {
      title: "Active DAs",
      value: liveMetrics.activeDA,
      trend: "Stable",
      prediction: "Need 2 more in Kano",
      icon: Users,
      color: "purple",
      alert: false,
      onClick: () => onModuleChange('multistate')
